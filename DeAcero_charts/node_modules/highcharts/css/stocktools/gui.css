...
.highcharts-bindings-wrapper .highcharts-arrow-down {
  background-image: url("https://code.highcharts.com/7.1.0/gfx/stock-icons/arrow-right.svg");
...
.highcharts-bindings-wrapper .highcharts-arrow-right {
  background: url("https://code.highcharts.com/7.1.0/gfx/stock-icons/arrow-bottom.svg") no-repeat right bottom;
...
.highcharts-toggle-toolbar {
  ...
  height: 10px;
  background-color: #f7f7f7;
  background-image: url("https://code.highcharts.com/gfx/7.1.0/stock-icons/arrow-right.svg");
  background-size: cover;
}
