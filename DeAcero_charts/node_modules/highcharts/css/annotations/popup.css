...
.highcharts-popup-close {
  background: url("https://code.highcharts.com/7.1.0/gfx/stock-icons/close.svg") no-repeat 50% 50%;
  width: 20px;
  height: 20px;
  cursor: pointer;
  position: absolute;
...
.highcharts-popup button.highcharts-annotation-edit-button {
  background: url("https://code.highcharts.com/7.1.0/gfx/stock-icons/edit.svg") no-repeat 50% 50% transparent;
  text-indent: -9999px;
}

.highcharts-popup button.highcharts-annotation-remove-button {
  background: url("https://code.highcharts.com/7.1.0/gfx/stock-icons/destroy.svg") no-repeat 50% 50% transparent;
  text-indent: -9999px;
}
