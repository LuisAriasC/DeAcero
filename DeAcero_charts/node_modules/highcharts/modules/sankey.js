...
{index:f,siblings:g.children.length,visible:g.visible});a=b(a,p);h.push(a);a.visible&&(e+=a.val)});g.visible=0<e||g.visible;p=a(l.value,e);d(g,{children:h,childrenTotal:e,isLeaf:g.visible&&!e,val:p});return g},updateRootId:function(b){var g;h(b)&&(g=h(b.options)?b.options:{},g=a(b.rootNode,g.rootId,""),h(b.userOptions)&&(b.userOptions.rootId=g),b.rootNode=g);return g}}});n(d,"modules/sankey.src.js",[d["parts/Globals.js"],d["mixins/tree-series.js"]],function(e,d){var n=d.getLevelOptions,h=e.defined,
k=e.isObject,I=e.merge;d=e.seriesType;var a=e.pick,q=e.Point;d("sankey","column",{borderWidth:0,colorByPoint:!0,curveFactor:.33,dataLabels:{enabled:!0,backgroundColor:"none",crop:!1,nodeFormat:void 0,nodeFormatter:function(){return this.point.name},format:void 0,formatter:function(){return""},inside:!0},inactiveOtherPoints:!0,linkOpacity:.5,nodeWidth:20,nodePadding:10,showInLegend:!1,states:{hover:{linkOpacity:1},inactive:{linkOpacity:.1,opacity:.1,animation:{duration:50}}},tooltip:{followPointer:!0,
headerFormat:'\x3cspan style\x3d"font-size: 10px"\x3e{series.name}\x3c/span\x3e\x3cbr/\x3e',pointFormat:"{point.fromNode.name} \u2192 {point.toNode.name}: \x3cb\x3e{point.weight}\x3c/b\x3e\x3cbr/\x3e",nodeFormat:"{point.name}: \x3cb\x3e{point.sum}\x3c/b\x3e\x3cbr/\x3e"}},{isCartesian:!1,invertable:!0,forceDL:!0,orderNodes:!0,createNode:e.NodesMixin.createNode,setData:e.NodesMixin.setData,destroy:e.NodesMixin.destroy,getNodePadding:function(){return this.options.nodePadding},createNodeColumn:function(){var b=
this.chart,a=[],c=this.getNodePadding();a.sum=function(){return this.reduce(function(b,c){return b+c.getSum()},0)};a.offset=function(b,f){for(var g=0,d,p=0;p<a.length;p++){d=a[p].getSum()*f+c;if(a[p]===b)return{relativeTop:g+e.relativeLength(b.options.offset||0,d)};g+=d}};a.top=function(a){var f=this.reduce(function(b,f){0<b&&(b+=c);return b+=f.getSum()*a},0);return(b.plotSizeY-f)/2};return a},createNodeColumns:function(){var b=[];this.nodes.forEach(function(c){var a=-1,f,g,d;if(!e.defined(c.options.column))if(0===
c.linksTo.length)c.column=0;else{for(g=0;g<c.linksTo.length;g++)d=c.linksTo[0],d.fromNode.column>a&&(f=d.fromNode,a=f.column);c.column=a+1;"hanging"===f.options.layout&&(c.hangsFrom=f,c.column+=f.linksFrom.findIndex(function(b){return b.toNode===c}))}b[c.column]||(b[c.column]=this.createNodeColumn());b[c.column].push(c)},this);for(var a=0;a<b.length;a++)void 0===b[a]&&(b[a]=this.createNodeColumn());return b},hasData:function(){return!!this.processedXData.length},pointAttribs:function(b,g){var c=this.mapOptionsToLevel[(b.isNode?
b.level:b.fromNode.level)||0],d=b.options,f=c.states[g]||{};g=["colorByPoint","borderColor","borderWidth","linkOpacity"].reduce(function(b,g){b[g]=a(f[g],d[g],c[g]);return b},{});var u=a(f.color,d.color,g.colorByPoint?b.color:c.color);return b.isNode?{fill:u,stroke:g.borderColor,"stroke-width":g.borderWidth}:{fill:e.color(u).setOpacity(g.linkOpacity).get()}},generatePoints:function(){function b(a,c){void 0===a.level&&(a.level=c,a.linksFrom.forEach(function(a){b(a.toNode,c+1)}))}e.NodesMixin.generatePoints.apply(this,
arguments);this.orderNodes&&(this.nodes.filter(function(b){return 0===b.linksTo.length}).forEach(function(a){b(a,0)}),e.stableSort(this.nodes,function(b,a){return b.level-a.level}))},translateNode:function(b,g){var c=this.translationFactor,d=this.chart,f=this.options,e=b.getSum(),m=Math.round(e*c),l=Math.round(f.borderWidth)%2/2,h=g.offset(b,c);g=Math.floor(a(h.absoluteTop,g.top(c)+h.relativeTop))+l;l=Math.floor(this.colDistance*b.column+f.borderWidth/2)+l;l=d.inverted?d.plotSizeX-l:l;c=Math.round(this.nodeWidth);
b.sum=e;b.shapeType="rect";b.nodeX=l;b.nodeY=g;b.shapeArgs=d.inverted?{x:l-c,y:d.plotSizeY-g-m,width:b.options.height||f.height||c,height:b.options.width||f.width||m}:{x:l,y:g,width:b.options.width||f.width||c,height:b.options.height||f.height||m};b.shapeArgs.display=b.hasShape()?"":"none";d=this.mapOptionsToLevel[b.level];f=b.options;f=k(f)?f.dataLabels:{};d=k(d)?d.dataLabels:{};d=I({style:{}},d,f);b.dlOptions=d;b.plotY=1},translateLink:function(b){var a=b.fromNode,c=b.toNode,d=this.chart,f=this.translationFactor,
