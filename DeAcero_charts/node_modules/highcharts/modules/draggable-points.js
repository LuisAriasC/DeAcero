...
*/
(function(k){"object"===typeof module&&module.exports?(k["default"]=k,module.exports=k):"function"===typeof define&&define.amd?define("highcharts/modules/draggable-points",["highcharts"],function(l){k(l);k.Highcharts=l;return k}):k("undefined"!==typeof Highcharts?Highcharts:void 0)})(function(k){function l(g,k,l,A){g.hasOwnProperty(k)||(g[k]=A.apply(null,l))}k=k?k._modules:{};l(k,"modules/draggable-points.src.js",[k["parts/Globals.js"]],function(g){function k(a){return{left:"right",right:"left",top:"bottom",
bottom:"top"}[a]}function l(a){var b=["draggableX","draggableY"],c;q(a.dragDropProps,function(a){a.optionName&&b.push(a.optionName)});for(c=b.length;c--;)if(a.options.dragDrop[b[c]])return!0}function A(a){var b=a.series?a.series.length:0;if(a.hasCartesianSeries&&!a.polar)for(;b--;)if(a.series[b].options.dragDrop&&l(a.series[b]))return!0}function M(a){var b=a.series,c=b.options.dragDrop||{};a=a.options&&a.options.dragDrop;var e,f;q(b.dragDropProps,function(a){"x"===a.axis&&a.move?e=!0:"y"===a.axis&&
a.move&&(f=!0)});return(c.draggableX&&e||c.draggableY&&f)&&!(a&&!1===a.draggableX&&!1===a.draggableY)&&b.yAxis&&b.xAxis}function w(a,b){return void 0===a.chartX||void 0===a.chartY?b.pointer.normalize(a):a}function u(a,b,c,e){var f=b.map(function(b){return p(a,b,c,e)});return function(){f.forEach(function(a){a()})}}function N(a,b,c){var e=b.dragDropData.origin;b=e.chartX;var e=e.chartY,f=a.chartX;a=a.chartY;return Math.sqrt((f-b)*(f-b)+(a-e)*(a-e))>c}function O(a,b,c){var e={chartX:a.chartX,chartY:a.chartY,
