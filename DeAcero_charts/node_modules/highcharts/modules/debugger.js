...
meta:{files:"errors/10/readme.md errors/10/enduser.md errors/11/readme.md errors/12/readme.md errors/13/readme.md errors/14/readme.md errors/15/readme.md errors/16/readme.md errors/17/readme.md errors/18/readme.md errors/19/readme.md errors/20/readme.md errors/21/readme.md errors/22/readme.md errors/23/readme.md errors/24/readme.md errors/25/readme.md errors/26/readme.md errors/27/readme.md errors/28/readme.md errors/29/readme.md errors/30/readme.md".split(" ")}}});b(a,"modules/debugger.src.js",[a["parts/Globals.js"]],
function(a){var b=a.addEvent,f=a.isNumber,c=a.setOptions,g=a.each;c({chart:{displayErrors:!0}});b(a.Chart,"displayError",function(b){var d=b.code,e=this.options.chart;b=this.renderer;var c;this.errorElements&&g(this.errorElements,function(a){a&&a.destroy()});e&&e.displayErrors&&(this.errorElements=[],d=f(d)?"Highcharts error #"+d+": "+a.errorMessages[d].title+a.errorMessages[d].text:d,e=this.chartWidth,c=this.chartHeight,this.errorElements[0]=b.rect(2,2,e-4,c-4).attr({"stroke-width":4,stroke:"#ff0000",
zIndex:3}).add(),this.errorElements[1]=b.label(d,0,0,"rect",null,null,!0).css({color:"#ffffff",width:e-16,padding:0}).attr({fill:"#ff0000",width:e,padding:8,zIndex:10}).add(),this.errorElements[1].attr({y:c-this.errorElements[1].getBBox().height}))});b(a.Chart,"beforeRedraw",function(){var a=this.errorElements;a&&a.length&&g(a,function(a){a.destroy()});this.errorElements=null})});b(a,"masters/modules/debugger.src.js",[],function(){})});
