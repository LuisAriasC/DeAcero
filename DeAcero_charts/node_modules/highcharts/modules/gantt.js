...
[this.track.element,"click",this.trackClick],[d,"mousedown",f],[d.ownerDocument,"mousemove",g],[d.ownerDocument,"mouseup",n]];k&&a.push([d,"touchstart",f],[d.ownerDocument,"touchmove",g],[d.ownerDocument,"touchend",n]);a.forEach(function(a){h.apply(null,a)});this._events=a},removeEvents:function(){this._events.forEach(function(a){D.apply(null,a)});this._events.length=0},destroy:function(){var a=this.chart.scroller;this.removeEvents();["track","scrollbarRifles","scrollbar","scrollbarGroup","group"].forEach(function(a){this[a]&&
this[a].destroy&&(this[a]=this[a].destroy())},this);a&&this===a.scrollbar&&(a.scrollbar=null,w(a.scrollbarButtons))}};a.Scrollbar||(h(x,"afterInit",function(){var b=this;b.options&&b.options.scrollbar&&b.options.scrollbar.enabled&&(b.options.scrollbar.vertical=!b.horiz,b.options.startOnTick=b.options.endOnTick=!1,b.scrollbar=new p(b.chart.renderer,b.options.scrollbar,b.chart),h(b.scrollbar,"changed",function(c){var d=Math.min(t(b.options.min,b.min),b.min,b.dataMin),f=Math.max(t(b.options.max,b.max),
b.max,b.dataMax)-d,g;b.horiz&&!b.reversed||!b.horiz&&b.reversed?(g=d+f*this.to,d+=f*this.from):(g=d+f*(1-this.from),d+=f*(1-this.to));t(this.options.liveRedraw,a.svg&&!a.isTouchDevice&&!this.chart.isBoosting)||"mouseup"===c.DOMType||!C(c.DOMType)?b.setExtremes(d,g,!0,"mousemove"!==c.DOMType,c):this.setRange(this.from,this.to)}))}),h(x,"afterRender",function(){var a=Math.min(t(this.options.min,this.min),this.min,t(this.dataMin,this.min)),c=Math.max(t(this.options.max,this.max),this.max,t(this.dataMax,
...
isNaN(a)||isNaN(c)||!C(this.min)||!C(this.max)?d.setRange(0,0):(f=(this.min-a)/(c-a),a=(this.max-a)/(c-a),this.horiz&&!this.reversed||!this.horiz&&this.reversed?d.setRange(f,a):d.setRange(1-a,1-f))}}),h(x,"afterGetOffset",function(){var a=this.horiz?2:1,c=this.scrollbar;c&&(this.chart.scrollbarsOffsets=[0,0],this.chart.axisOffset[a]+=c.size+c.options.margin)}),a.Scrollbar=p)});G(v,"parts/RangeSelector.js",[v["parts/Globals.js"]],function(a){function p(a){this.init(a)}var h=a.addEvent,x=a.Axis,u=a.Chart,
v=a.css,C=a.createElement,w=a.defaultOptions,H=a.defined,k=a.destroyObjectProperties,m=a.discardElement,t=a.extend,D=a.fireEvent,B=a.isNumber,d=a.merge,b=a.pick,c=a.pInt,l=a.splat;t(w,{rangeSelector:{verticalAlign:"top",buttonTheme:{width:28,height:18,padding:2,zIndex:7},floating:!1,x:0,y:0,height:void 0,inputPosition:{align:"right",x:0,y:0},buttonPosition:{align:"left",x:0,y:0},labelStyle:{color:"#666666"}}});w.lang=d(w.lang,{rangeSelectorZoom:"Zoom",rangeSelectorFrom:"From",rangeSelectorTo:"To"});
p.prototype={clickButton:function(a,c){var f=this.chart,d=this.buttonOptions[a],e=f.xAxis[0],g=f.scroller&&f.scroller.getUnionExtremes()||e||{},r=g.dataMin,k=g.dataMax,E,z=e&&Math.round(Math.min(e.max,b(k,e.max))),m=d.type,p,g=d._range,t,u,w,T=d.dataGrouping;if(null!==r&&null!==k){f.fixedRange=g;T&&(this.forcedDataGrouping=!0,x.prototype.setDataGrouping.call(e||{chart:this.chart},T,!1),this.frozenStates=d.preserveDataGrouping);if("month"===m||"year"===m)e?(m={range:d,max:z,chart:f,dataMin:r,dataMax:k},
E=e.minFromRange.call(m),B(m.newMax)&&(z=m.newMax)):g=d;else if(g)E=Math.max(z-g,r),z=Math.min(E+g,k);else if("ytd"===m)if(e)void 0===k&&(r=Number.MAX_VALUE,k=Number.MIN_VALUE,f.series.forEach(function(a){a=a.xData;r=Math.min(a[0],r);k=Math.max(a[a.length-1],k)}),c=!1),z=this.getYTDExtremes(k,r,f.time.useUTC),E=t=z.min,z=z.max;else{this.deferredYTDClick=a;return}else"all"===m&&e&&(E=r,z=k);E+=d._offsetMin;z+=d._offsetMax;this.setSelected(a);e?e.setExtremes(E,z,b(c,1),null,{trigger:"rangeSelectorButton",
rangeSelectorButton:d}):(p=l(f.options.xAxis)[0],w=p.range,p.range=g,u=p.min,p.min=t,h(f,"load",function(){p.range=w;p.min=u}))}},setSelected:function(a){this.selected=this.options.selected=a},defaultButtons:[{type:"month",count:1,text:"1m"},{type:"month",count:3,text:"3m"},{type:"month",count:6,text:"6m"},{type:"ytd",text:"YTD"},{type:"year",count:1,text:"1y"},{type:"all",text:"All"}],init:function(a){var b=this,c=a.options.rangeSelector,f=c.buttons||[].concat(b.defaultButtons),e=c.selected,d=function(){var a=
b.minInput,e=b.maxInput;a&&a.blur&&D(a,"blur");e&&e.blur&&D(e,"blur")};b.chart=a;b.options=c;b.buttons=[];b.buttonOptions=f;this.unMouseDown=h(a.container,"mousedown",d);this.unResize=h(a,"resize",d);f.forEach(b.computeButtonRange);void 0!==e&&f[e]&&this.clickButton(e,!1);h(a,"load",function(){a.xAxis&&a.xAxis[0]&&h(a.xAxis[0],"setExtremes",function(e){this.max-this.min!==a.fixedRange&&"rangeSelectorButton"!==e.trigger&&"updatedData"!==e.trigger&&b.forcedDataGrouping&&!b.frozenStates&&this.setDataGrouping(!1,
!1)})})},updateButtonStates:function(){var a=this,b=this.chart,c=b.xAxis[0],d=Math.round(c.max-c.min),e=!c.hasVisibleSeries,q=b.scroller&&b.scroller.getUnionExtremes()||c,r=q.dataMin,h=q.dataMax,b=a.getYTDExtremes(h,r,b.time.useUTC),k=b.min,z=b.max,l=a.selected,m=B(l),p=a.options.allButtonsEnabled,t=a.buttons;a.buttonOptions.forEach(function(b,f){var g=b._range,q=b.type,n=b.count||1,E=t[f],y=0,F=b._offsetMax-b._offsetMin;b=f===l;var u=g>h-r,V=g<c.minRange,S=!1,w=!1,g=g===d;("month"===q||"year"===
q)&&d+36E5>=864E5*{month:28,year:365}[q]*n-F&&d-36E5<=864E5*{month:31,year:366}[q]*n+F?g=!0:"ytd"===q?(g=z-k+F===d,S=!b):"all"===q&&(g=c.max-c.min>=h-r,w=!b&&m&&g);q=!p&&(u||V||w||e);n=b&&g||g&&!m&&!S||b&&a.frozenStates;q?y=3:n&&(m=!0,y=2);E.state!==y&&(E.setState(y),0===y&&l===f&&a.setSelected(null))})},computeButtonRange:function(a){var c=a.type,d=a.count||1,f={millisecond:1,second:1E3,minute:6E4,hour:36E5,day:864E5,week:6048E5};if(f[c])a._range=f[c]*d;else if("month"===c||"year"===c)a._range=864E5*
{month:30,year:365}[c]*d;a._offsetMin=b(a.offsetMin,0);a._offsetMax=b(a.offsetMax,0);a._range+=a._offsetMax-a._offsetMin},setInputValue:function(a,b){var c=this.chart.options.rangeSelector,d=this.chart.time,e=this[a+"Input"];H(b)&&(e.previousValue=e.HCTime,e.HCTime=b);e.value=d.dateFormat(c.inputEditDateFormat||"%Y-%m-%d",e.HCTime);this[a+"DateBox"].attr({text:d.dateFormat(c.inputDateFormat||"%b %e, %Y",e.HCTime)})},showInput:function(a){var b=this.inputGroup,c=this[a+"DateBox"];v(this[a+"Input"],
{left:b.translateX+c.x+"px",top:b.translateY+"px",width:c.width-2+"px",height:c.height-2+"px",border:"2px solid silver"})},hideInput:function(a){v(this[a+"Input"],{border:0,width:"1px",height:"1px"});this.setInputValue(a)},drawInput:function(b){function f(){var a=z.value,b=(r.inputDateParser||Date.parse)(a),e=h.xAxis[0],d=h.scroller&&h.scroller.xAxis?h.scroller.xAxis:e,f=d.dataMin,d=d.dataMax;b!==z.previousValue&&(z.previousValue=b,B(b)||(b=a.split("-"),b=Date.UTC(c(b[0]),c(b[1])-1,c(b[2]))),B(b)&&
(h.time.useUTC||(b+=6E4*(new Date).getTimezoneOffset()),l?b>n.maxInput.HCTime?b=void 0:b<f&&(b=f):b<n.minInput.HCTime?b=void 0:b>d&&(b=d),void 0!==b&&e.setExtremes(l?b:e.min,l?e.max:b,void 0,void 0,{trigger:"rangeSelectorInput"})))}var n=this,h=n.chart,e=h.renderer.style||{},q=h.renderer,r=h.options.rangeSelector,k=n.div,l="min"===b,z,m,p=this.inputGroup;this[b+"Label"]=m=q.label(w.lang[l?"rangeSelectorFrom":"rangeSelectorTo"],this.inputGroup.offset).addClass("highcharts-range-label").attr({padding:2}).add(p);
p.offset+=m.width+5;this[b+"DateBox"]=q=q.label("",p.offset).addClass("highcharts-range-input").attr({padding:2,width:r.inputBoxWidth||90,height:r.inputBoxHeight||17,"text-align":"center"}).on("click",function(){n.showInput(b);n[b+"Input"].focus()});h.styledMode||q.attr({stroke:r.inputBoxBorderColor||"#cccccc","stroke-width":1});q.add(p);p.offset+=q.width+(l?10:0);this[b+"Input"]=z=C("input",{name:b,className:"highcharts-range-selector",type:"text"},{top:h.plotTop+"px"},k);h.styledMode||(m.css(d(e,
r.labelStyle)),q.css(d({color:"#333333"},e,r.inputStyle)),v(z,t({position:"absolute",border:0,width:"1px",height:"1px",padding:0,textAlign:"center",fontSize:e.fontSize,fontFamily:e.fontFamily,top:"-9999em"},r.inputStyle)));z.onfocus=function(){n.showInput(b)};z.onblur=function(){z===a.doc.activeElement&&(f(),n.hideInput(b),z.blur())};z.onchange=f;z.onkeypress=function(a){13===a.keyCode&&f()}},getPosition:function(){var a=this.chart,b=a.options.rangeSelector,a="top"===b.verticalAlign?a.plotTop-a.axisOffset[0]:
0;return{buttonTop:a+b.buttonPosition.y,inputTop:a+b.inputPosition.y-10}},getYTDExtremes:function(a,b,c){var d=this.chart.time,e=new d.Date(a),f=d.get("FullYear",e);c=c?d.Date.UTC(f,0,1):+new d.Date(f,0,1);b=Math.max(b||0,c);e=e.getTime();return{max:Math.min(a||e,e),min:b}},render:function(a,c){var d=this,f=d.chart,e=f.renderer,g=f.container,r=f.options,h=r.exporting&&!1!==r.exporting.enabled&&r.navigation&&r.navigation.buttonOptions,k=w.lang,l=d.div,m=r.rangeSelector,p=b(r.chart.style&&r.chart.style.zIndex,
0)+1,r=m.floating,t=d.buttons,l=d.inputGroup,u=m.buttonTheme,v=m.buttonPosition,x=m.inputPosition,A=m.inputEnabled,B=u&&u.states,D=f.plotLeft,H,G=d.buttonGroup,L;L=d.rendered;var M=d.options.verticalAlign,O=f.legend,P=O&&O.options,Q=v.y,N=x.y,R=L||!1,U=R?"animate":"attr",K=0,I=0,J;if(!1!==m.enabled){L||(d.group=L=e.g("range-selector-group").attr({zIndex:7}).add(),d.buttonGroup=G=e.g("range-selector-buttons").add(L),d.zoomText=e.text(k.rangeSelectorZoom,0,15).add(G),f.styledMode||(d.zoomText.css(m.labelStyle),
u["stroke-width"]=b(u["stroke-width"],0)),d.buttonOptions.forEach(function(a,b){t[b]=e.button(a.text,0,0,function(e){var c=a.events&&a.events.click,f;c&&(f=c.call(a,e));!1!==f&&d.clickButton(b);d.isActive=!0},u,B&&B.hover,B&&B.select,B&&B.disabled).attr({"text-align":"center"}).add(G)}),!1!==A&&(d.div=l=C("div",null,{position:"relative",height:0,zIndex:p}),g.parentNode.insertBefore(l,g),d.inputGroup=l=e.g("input-group").add(L),l.offset=0,d.drawInput("min"),d.drawInput("max")));d.zoomText[U]({x:b(D+
v.x,D)});H=b(D+v.x,D)+d.zoomText.getBBox().width+5;d.buttonOptions.forEach(function(a,e){t[e][U]({x:H});H+=t[e].width+b(m.buttonSpacing,5)});D=f.plotLeft-f.spacing[3];d.updateButtonStates();h&&this.titleCollision(f)&&"top"===M&&"right"===v.align&&v.y+G.getBBox().height-12<(h.y||0)+h.height&&(K=-40);"left"===v.align?J=v.x-f.spacing[3]:"right"===v.align&&(J=v.x+K-f.spacing[1]);G.align({y:v.y,width:G.getBBox().width,align:v.align,x:J},!0,f.spacingBox);d.group.placed=R;d.buttonGroup.placed=R;!1!==A&&
(K=h&&this.titleCollision(f)&&"top"===M&&"right"===x.align&&x.y-l.getBBox().height-12<(h.y||0)+h.height+f.spacing[0]?-40:0,"left"===x.align?J=D:"right"===x.align&&(J=-Math.max(f.axisOffset[1],-K)),l.align({y:x.y,width:l.getBBox().width,align:x.align,x:x.x+J-2},!0,f.spacingBox),g=l.alignAttr.translateX+l.alignOptions.x-K+l.getBBox().x+2,h=l.alignOptions.width,k=G.alignAttr.translateX+G.getBBox().x,J=G.getBBox().width+20,(x.align===v.align||k+J>g&&g+h>k&&Q<N+l.getBBox().height)&&l.attr({translateX:l.alignAttr.translateX+
(f.axisOffset[1]>=-K?0:-K),translateY:l.alignAttr.translateY+G.getBBox().height+10}),d.setInputValue("min",a),d.setInputValue("max",c),d.inputGroup.placed=R);d.group.align({verticalAlign:M},!0,f.spacingBox);a=d.group.getBBox().height+20;c=d.group.alignAttr.translateY;"bottom"===M&&(O=P&&"bottom"===P.verticalAlign&&P.enabled&&!P.floating?O.legendHeight+b(P.margin,10):0,a=a+O-20,I=c-a-(r?0:m.y)-10);if("top"===M)r&&(I=0),f.titleOffset&&(I=f.titleOffset+f.options.title.margin),I+=f.margin[0]-f.spacing[0]||
...
this.range,c={month:"Month",year:"FullYear"}[a.type],d,h=this.max,e,q,r=function(a,b){var e=new Date(a),d=e["get"+c]();e["set"+c](d+b);d===e["get"+c]()&&e.setDate(0);return e.getTime()-a};B(a)?(d=h-a,q=a):(d=h+r(h,-a.count),this.chart&&(this.chart.fixedRange=h-d));e=b(this.dataMin,Number.MIN_VALUE);B(d)||(d=e);d<=e&&(d=e,void 0===q&&(q=r(d,a.count)),this.newMax=Math.min(d+q,this.dataMax));B(h)||(d=void 0);return d};a.RangeSelector||(h(u,"afterGetContainer",function(){this.options.rangeSelector.enabled&&
...
f=this.outline.strokeWidth(),g=f/2,f=f%2/2,q=this.outlineHeight,h=this.scrollbarHeight,r=this.size,k=this.left-h,l=this.top;c?(k-=g,c=l+b+f,b=l+a+f,a=["M",k+q,l-h-f,"L",k+q,c,"L",k,c,"L",k,b,"L",k+q,b,"L",k+q,l+r+h].concat(e?["M",k+q,c-g,"L",k+q,b+g]:[])):(a+=k+h-f,b+=k+h-f,l+=g,a=["M",k,l,"L",a,l,"L",a,l+q,"L",b,l+q,"L",b,l,"L",k+r+2*h,l].concat(e?["M",a-g,l,"L",b+g,l]:[]));this.outline[d]({d:a})},drawMasks:function(a,b,c,d){var e=this.left,f=this.top,g=this.height,q,h,r,k;c?(r=[e,e,e],k=[f,f+a,
f+b],h=[g,g,g],q=[a,b-a,this.size-b]):(r=[e,e+a,e+b],k=[f,f,f],h=[a,b-a,this.size-b],q=[g,g,g]);this.shades.forEach(function(a,b){a[d]({x:r[b],y:k[b],width:h[b],height:q[b]})})},renderElements:function(){var a=this,b=a.navigatorOptions,c=b.maskInside,d=a.chart,f=d.renderer,g,h={cursor:d.inverted?"ns-resize":"ew-resize"};a.navigatorGroup=g=f.g("navigator").attr({zIndex:8,visibility:"hidden"}).add();[!c,c,!c].forEach(function(e,c){a.shades[c]=f.rect().addClass("highcharts-navigator-mask"+(1===c?"-inside":
...
["left","right"][e]).add(g);if(!d.styledMode){var c=b.handles;a.handles[e].attr({fill:c.backgroundColor,stroke:c.borderColor,"stroke-width":c.lineWidth}).css(h)}})},update:function(a){(this.series||[]).forEach(function(a){a.baseSeries&&delete a.baseSeries.navigatorSeries});this.destroy();b(!0,this.chart.options.navigator,this.options,a);this.init(this.chart)},render:function(b,d,f,g){var e=this.chart,h,q,r=this.scrollbarHeight,k,l=this.xAxis;h=l.fake?e.xAxis[0]:l;var n=this.navigatorEnabled,m,p=this.rendered;
q=e.inverted;var t,u=e.xAxis[0].minRange,F=e.xAxis[0].options.maxRange;if(!this.hasDragged||w(f)){if(!B(b)||!B(d))if(p)f=0,g=c(l.width,h.width);else return;this.left=c(l.left,e.plotLeft+r+(q?e.plotWidth:0));this.size=m=k=c(l.len,(q?e.plotHeight:e.plotWidth)-2*r);e=q?r:k+2*r;f=c(f,l.toPixels(b,!0));g=c(g,l.toPixels(d,!0));B(f)&&Infinity!==Math.abs(f)||(f=0,g=e);b=l.toValue(f,!0);d=l.toValue(g,!0);t=Math.abs(a.correctFloat(d-b));t<u?this.grabbedLeft?f=l.toPixels(d-u,!0):this.grabbedRight&&(g=l.toPixels(b+
u,!0)):w(F)&&t>F&&(this.grabbedLeft?f=l.toPixels(d-F,!0):this.grabbedRight&&(g=l.toPixels(b+F,!0)));this.zoomedMax=Math.min(Math.max(f,g,0),m);this.zoomedMin=Math.min(Math.max(this.fixedWidth?this.zoomedMax-this.fixedWidth:Math.min(f,g),0),m);this.range=this.zoomedMax-this.zoomedMin;m=Math.round(this.zoomedMax);f=Math.round(this.zoomedMin);n&&(this.navigatorGroup.attr({visibility:"visible"}),p=p&&!this.hasDragged?"animate":"attr",this.drawMasks(f,m,q,p),this.drawOutline(f,m,q,p),this.navigatorOptions.handles.enabled&&
(this.drawHandle(f,0,q,p),this.drawHandle(m,1,q,p)));this.scrollbar&&(q?(q=this.top-r,h=this.left-r+(n||!h.opposite?0:(h.titleOffset||0)+h.axisTitleMargin),r=k+2*r):(q=this.top+(n?this.height:-r),h=this.left-r),this.scrollbar.position(h,q,e,r),this.scrollbar.setRange(this.zoomedMin/(k||1),this.zoomedMax/(k||1)));this.rendered=!0}},addMouseEvents:function(){var a=this,b=a.chart,c=b.container,d=[],f,g;a.mouseMoveHandler=f=function(b){a.onMouseMove(b)};a.mouseUpHandler=g=function(b){a.onMouseUp(b)};
d=a.getPartsEvents("mousedown");d.push(h(c,"mousemove",f),h(c.ownerDocument,"mouseup",g));t&&(d.push(h(c,"touchmove",f),h(c.ownerDocument,"touchend",g)),d.concat(a.getPartsEvents("touchstart")));a.eventsToUnbind=d;a.series&&a.series[0]&&d.push(h(a.series[0].xAxis,"foundExtremes",function(){b.navigator.modifyNavigatorAxisExtremes()}))},getPartsEvents:function(a){var b=this,e=[];["shades","handles"].forEach(function(c){b[c].forEach(function(d,f){e.push(h(d.element,a,function(a){b[c+"Mousedown"](a,f)}))})});
...
n,p={enableMouseTracking:!1,index:null,linkedTo:null,group:"nav",padXAxis:!1,xAxis:"navigator-x-axis",yAxis:"navigator-y-axis",showInLegend:!1,stacking:!1,isInternal:!0,states:{inactive:{opacity:1}}},t=e.series=(e.series||[]).filter(function(a){var b=a.baseSeries;return 0>g.indexOf(b)?(b&&(l(b,"updatedData",e.updatedDataHandler),delete b.navigatorSeries),a.chart&&a.destroy(),!1):!0});g&&g.length&&g.forEach(function(a){var c=a.navigatorSeries,l=m({color:a.color,visible:a.visible},D(q)?C.navigator.series:
q);c&&!1===e.navigatorOptions.adaptToUpdatedData||(p.name="Navigator "+g.length,h=a.options||{},n=h.navigatorOptions||{},k=b(h,p,l,n),l=n.data||l.data,e.hasNavigatorData=e.hasNavigatorData||!!l,k.data=l||h.data&&h.data.slice(0),c&&c.options?c.update(k,d):(a.navigatorSeries=f.initSeries(k),a.navigatorSeries.baseSeries=a,t.push(a.navigatorSeries)))});if(q.data&&(!g||!g.length)||D(q))e.hasNavigatorData=!1,q=a.splat(q),q.forEach(function(a,c){p.name="Navigator "+(t.length+1);k=b(C.navigator.series,{color:f.series[c]&&
!f.series[c].options.isInternal&&f.series[c].color||f.options.colors[c]||f.options.colors[0]},p,a);k.data=a.data;k.data&&(e.hasNavigatorData=!0,t.push(f.initSeries(k)))});c&&this.addBaseSeriesEvents()},addBaseSeriesEvents:function(){var a=this,b=a.baseSeries||[];b[0]&&b[0].xAxis&&h(b[0].xAxis,"foundExtremes",this.modifyBaseAxisExtremes);b.forEach(function(b){h(b,"show",function(){this.navigatorSeries&&this.navigatorSeries.setVisible(!0,!1)});h(b,"hide",function(){this.navigatorSeries&&this.navigatorSeries.setVisible(!1,
...
!1)}),u.prototype.callbacks.push(function(a){var b=a.navigator;b&&a.xAxis[0]&&(a=a.xAxis[0].getExtremes(),b.render(a.min,a.max))}))});G(v,"masters/modules/gantt.src.js",[],function(){})});
