...
d=b.inverted;var r,t=b.xAxis[0].minRange,u=b.xAxis[0].options.maxRange;if(!this.hasDragged||x(f)){if(!p(h)||!p(e))if(v)f=0,a=k(g.width,y.width);else return;this.left=k(g.left,b.plotLeft+m+(d?b.plotWidth:0));this.size=w=n=k(g.len,(d?b.plotHeight:b.plotWidth)-2*m);b=d?m:n+2*m;f=k(f,g.toPixels(h,!0));a=k(a,g.toPixels(e,!0));p(f)&&Infinity!==Math.abs(f)||(f=0,a=b);h=g.toValue(f,!0);e=g.toValue(a,!0);r=Math.abs(c.correctFloat(e-h));r<t?this.grabbedLeft?f=g.toPixels(e-t,!0):this.grabbedRight&&(a=g.toPixels(h+
t,!0)):x(u)&&r>u&&(this.grabbedLeft?f=g.toPixels(e-u,!0):this.grabbedRight&&(a=g.toPixels(h+u,!0)));this.zoomedMax=Math.min(Math.max(f,a,0),w);this.zoomedMin=Math.min(Math.max(this.fixedWidth?this.zoomedMax-this.fixedWidth:Math.min(f,a),0),w);this.range=this.zoomedMax-this.zoomedMin;w=Math.round(this.zoomedMax);f=Math.round(this.zoomedMin);l&&(this.navigatorGroup.attr({visibility:"visible"}),v=v&&!this.hasDragged?"animate":"attr",this.drawMasks(f,w,d,v),this.drawOutline(f,w,d,v),this.navigatorOptions.handles.enabled&&
...
a=h.getPartsEvents("mousedown");a.push(t(f,"mousemove",b),t(f.ownerDocument,"mouseup",d));g&&(a.push(t(f,"touchmove",b),t(f.ownerDocument,"touchend",d)),a.concat(h.getPartsEvents("touchstart")));h.eventsToUnbind=a;h.series&&h.series[0]&&a.push(t(h.series[0].xAxis,"foundExtremes",function(){e.navigator.modifyNavigatorAxisExtremes()}))},getPartsEvents:function(h){var e=this,f=[];["shades","handles"].forEach(function(a){e[a].forEach(function(b,y){f.push(t(b.element,h,function(f){e[a+"Mousedown"](f,y)}))})});
...
0,-c,0],width:e}:{offsets:[0,-c,0,c],height:e})),g.yAxis=new q(h,b(f.yAxis,{id:"navigator-y-axis",alignTicks:!1,offset:0,index:n,isInternal:!0,zoomEnabled:!1},h.inverted?{width:e}:{height:e})),d||f.series.data?g.updateNavigatorSeries(!1):0===h.series.length&&(g.unbindRedraw=t(h,"beforeRedraw",function(){0<h.series.length&&!g.series&&(g.setBaseSeries(),g.unbindRedraw())})),g.reversedExtremes=h.inverted&&!g.xAxis.reversed||!h.inverted&&g.xAxis.reversed,g.renderElements(),g.addMouseEvents()):g.xAxis=
{translate:function(f,e){var a=h.xAxis[0],b=a.getExtremes(),d=a.len-2*c,m=w("min",a.options.min,b.dataMin),a=w("max",a.options.max,b.dataMax)-m;return e?f*a/d+m:d*(f-m)/a},toPixels:function(f){return this.translate(f)},toValue:function(f){return this.translate(f,!0)},toFixedRange:q.prototype.toFixedRange,fake:!0};h.options.scrollbar.enabled&&(h.scrollbar=g.scrollbar=new a(h.renderer,b(h.options.scrollbar,{margin:g.navigatorEnabled?0:10,vertical:h.inverted}),h),t(g.scrollbar,"changed",function(f){var a=
...
(this.eventsToUnbind=[]);this.eventsToUnbind.push(t(this.chart,"redraw",function(){var a=this.navigator,e=a&&(a.baseSeries&&a.baseSeries[0]&&a.baseSeries[0].xAxis||a.scrollbar&&this.xAxis[0]);e&&a.render(e.min,e.max)}),t(this.chart,"getMargins",function(){var a=this.navigator,e=a.opposite?"plotTop":"marginBottom";this.inverted&&(e=a.opposite?"marginRight":"plotLeft");this[e]=(this[e]||0)+(a.navigatorEnabled||!this.inverted?a.outlineHeight:0)+a.navigatorOptions.margin}))},destroy:function(){this.removeEvents();
...
t(q,"zoom",function(a){var e=this.chart.options,f=e.chart.zoomType,b=e.chart.pinchType,h=e.navigator,e=e.rangeSelector;this.isXAxis&&(h&&h.enabled||e&&e.enabled)&&("y"===f?a.zoomed=!1:(!d&&"xy"===f||d&&"xy"===b)&&this.options.range&&(f=this.previousZoom,x(a.newMin)?this.previousZoom=[this.min,this.max]:f&&(a.newMin=f[0],a.newMax=f[1],delete this.previousZoom)));void 0!==a.zoomed&&a.preventDefault()}),t(u,"beforeShowResetZoom",function(){var a=this.options,e=a.navigator,f=a.rangeSelector;if((e&&e.enabled||
f&&f.enabled)&&(!d&&"x"===a.chart.zoomType||d&&"x"===a.chart.pinchType))return!1}),t(u,"beforeRender",function(){var a=this.options;if(a.navigator.enabled||a.scrollbar.enabled)this.scroller=this.navigator=new E(this)}),t(u,"afterSetChartSize",function(){var a=this.legend,e=this.navigator,f,b,d,m;e&&(b=a&&a.options,d=e.xAxis,m=e.yAxis,f=e.scrollbarHeight,this.inverted?(e.left=e.opposite?this.chartWidth-f-e.height:this.spacing[3]+f,e.top=this.plotTop+f):(e.left=this.plotLeft+f,e.top=e.navigatorOptions.top||
this.chartHeight-e.height-f-this.spacing[2]-(this.rangeSelector&&this.extraBottomMargin?this.rangeSelector.getHeight():0)-(b&&"bottom"===b.verticalAlign&&b.enabled&&!b.floating?a.legendHeight+k(b.margin,10):0)),d&&m&&(this.inverted?d.options.left=m.options.left=e.left:d.options.top=m.options.top=e.top,d.setAxisSize(),m.setAxisSize()))}),t(u,"update",function(a){var e=a.options.navigator||{},f=a.options.scrollbar||{};this.navigator||this.scroller||!e.enabled&&!f.enabled||(b(!0,this.options.navigator,
e),b(!0,this.options.scrollbar,f),delete a.options.navigator,delete a.options.scrollbar)}),t(u,"afterUpdate",function(a){this.navigator||this.scroller||!this.options.navigator.enabled&&!this.options.scrollbar.enabled||(this.scroller=this.navigator=new E(this),k(a.redraw,!0)&&this.redraw(a.animation))}),t(u,"afterAddSeries",function(){this.navigator&&this.navigator.setBaseSeries(null,!1)}),t(n,"afterUpdate",function(){this.chart.navigator&&!this.options.isInternal&&this.chart.navigator.setBaseSeries(null,
!1)}),u.prototype.callbacks.push(function(a){var e=a.navigator;e&&a.xAxis[0]&&(a=a.xAxis[0].getExtremes(),e.render(a.min,a.max))}))});B(q,"parts/OrdinalAxis.js",[q["parts/Globals.js"]],function(c){var E=c.addEvent,t=c.Axis,q=c.Chart,u=c.css,z=c.defined,A=c.extend,x=c.noop,D=c.pick,C=c.timeUnits;E(c.Series,"updatedData",function(){var c=this.xAxis;c&&c.options.ordinal&&delete c.ordinalIndex});t.prototype.getTimeTicks=function(c,g,r,p,d,b,k){var l=0,a,n,m={},w,h,e,f=[],y=-Number.MAX_VALUE,G=this.options.tickPixelInterval,
F=this.chart.time,H=[];if(!this.options.ordinal&&!this.options.breaks||!d||3>d.length||void 0===g)return F.getTimeTicks.apply(F,arguments);h=d.length;for(a=0;a<h;a++){e=a&&d[a-1]>r;d[a]<g&&(l=a);if(a===h-1||d[a+1]-d[a]>5*b||e){if(d[a]>y){for(n=F.getTimeTicks(c,d[l],d[a],p);n.length&&n[0]<=y;)n.shift();n.length&&(y=n[n.length-1]);H.push(f.length);f=f.concat(n)}l=a+1}if(e)break}n=n.info;if(k&&n.unitRange<=C.hour){a=f.length-1;for(l=1;l<a;l++)F.dateFormat("%d",f[l])!==F.dateFormat("%d",f[l-1])&&(m[f[l]]=
"day",w=!0);w&&(m[f[0]]="day");n.higherRanks=m}n.segmentStarts=H;f.info=n;if(k&&z(G)){l=H=f.length;w=[];for(var t,F=[];l--;)a=this.translate(f[l]),t&&(F[l]=t-a),w[l]=t=a;F.sort();F=F[Math.floor(F.length/2)];F<.6*G&&(F=null);l=f[H-1]>r?H-1:H;for(t=void 0;l--;)a=w[l],H=Math.abs(t-a),t&&H<.8*G&&(null===F||H<.8*F)?(m[f[l]]&&!m[f[l+1]]?(H=l+1,t=a):H=l,f.splice(H,1)):t=a}return f};A(t.prototype,{beforeSetTickPositions:function(){var c,g=[],r,p=!1,d,b=this.getExtremes(),k=b.min,v=b.max,a,n=this.isXAxis&&
!!this.options.breaks,b=this.options.ordinal,m=Number.MAX_VALUE,w=this.chart.options.chart.ignoreHiddenSeries,h;if(b||n){this.series.forEach(function(a,f){r=[];if(!(w&&!1===a.visible||!1===a.takeOrdinalPosition&&!n)&&(g=g.concat(a.processedXData),c=g.length,g.sort(function(a,f){return a-f}),m=Math.min(m,D(a.closestPointRange,m)),c)){for(f=0;f<c-1;)g[f]!==g[f+1]&&r.push(g[f+1]),f++;r[0]!==g[0]&&r.unshift(g[0]);g=r}a.isSeriesBoosting&&(h=!0)});h&&(g.length=0);c=g.length;if(2<c){d=g[1]-g[0];for(a=c-
...
if(l){var p=this.ordinalSlope,d=this.ordinalOffset,b=l.length-1,k;if(g)0>c?c=l[0]:c>b?c=l[b]:(b=Math.floor(c),k=c-b);else for(;b--;)if(g=p*b+d,c>=g){p=p*(b+1)+d;k=(c-g)/(p-g);break}return void 0!==k&&void 0!==l[b]?l[b]+(k?k*(l[b+1]-l[b]):0):c}return c},getExtendedPositions:function(){var c=this,g=c.chart,r=c.series[0].currentDataGrouping,p=c.ordinalIndex,d=r?r.count+r.unitName:"raw",b=c.options.overscroll,k=c.getExtremes(),v,a;p||(p=c.ordinalIndex={});p[d]||(v={series:[],chart:g,getExtremes:function(){return{min:k.dataMin,
max:k.dataMax+b}},options:{ordinal:!0},val2lin:t.prototype.val2lin,ordinal2lin:t.prototype.ordinal2lin},c.series.forEach(function(b){a={xAxis:v,xData:b.xData.slice(),chart:g,destroyGroupedData:x};a.xData=a.xData.concat(c.getOverscrollPositions());a.options={dataGrouping:r?{enabled:!0,forced:!0,approximation:"open",units:[[r.unitName,[r.count]]]}:{enabled:!1}};b.processData.apply(a);v.series.push(a)}),c.beforeSetTickPositions.apply(v),p[d]=v.ordinalPositions);return p[d]},getOverscrollPositions:function(){var l=
this.options.overscroll,g=this.overscrollPointsRange,r=[],p=this.dataMax;if(c.defined(g))for(r.push(p);p<=this.dataMax+l;)p+=g,r.push(p);return r},getGroupIntervalFactor:function(c,g,r){var l;r=r.processedXData;var d=r.length,b=[];l=this.groupIntervalFactor;if(!l){for(l=0;l<d-1;l++)b[l]=r[l+1]-r[l];b.sort(function(b,d){return b-d});b=b[Math.floor(d/2)];c=Math.max(c,r[0]);g=Math.min(g,r[d-1]);this.groupIntervalFactor=l=d*b/(g-c)}return l},postProcessTickInterval:function(c){var g=this.ordinalSlope;
return g?this.options.breaks?this.closestPointRange||c:c/(g/this.closestPointRange):c}});t.prototype.ordinal2lin=t.prototype.val2lin;E(q,"pan",function(c){var g=this.xAxis[0],l=g.options.overscroll,p=c.originalEvent.chartX,d=!1;if(g.options.ordinal&&g.series.length){var b=this.mouseDownX,k=g.getExtremes(),v=k.dataMax,a=k.min,n=k.max,m=this.hoverPoints,w=g.closestPointRange||g.overscrollPointsRange,b=(b-p)/(g.translationSlope*(g.ordinalSlope||w)),h={ordinalPositions:g.getExtendedPositions()},w=g.lin2val,
...
g.dataMax+l):c.preventDefault()});E(t,"foundExtremes",function(){this.isXAxis&&z(this.options.overscroll)&&this.max===this.dataMax&&(!this.chart.mouseIsDown||this.isInternal)&&(!this.eventArgs||this.eventArgs&&"navigator"!==this.eventArgs.trigger)&&(this.max+=this.options.overscroll,!this.isInternal&&z(this.userMin)&&(this.min+=this.options.overscroll))})});B(q,"modules/broken-axis.src.js",[q["parts/Globals.js"]],function(c){var E=c.addEvent,t=c.pick,q=c.extend,u=c.isArray,z=c.find,A=c.fireEvent,
x=c.Axis,D=c.Series,C=function(c,g){return z(g,function(g){return g.from<c&&c<g.to})};q(x.prototype,{isInBreak:function(c,g){var l=c.repeat||Infinity,p=c.from,d=c.to-c.from;g=g>=p?(g-p)%l:l-(p-g)%l;return c.inclusive?g<=d:g<d&&0!==g},isInAnyBreak:function(c,g){var l=this.options.breaks,p=l&&l.length,d,b,k;if(p){for(;p--;)this.isInBreak(l[p],c)&&(d=!0,b||(b=t(l[p].showPoints,!this.isXAxis)));k=d&&g?d&&!b:d}return k}});E(x,"afterInit",function(){"function"===typeof this.setBreaks&&this.setBreaks(this.options.breaks,
!1)});E(x,"afterSetTickPositions",function(){if(this.isBroken){var c=this.tickPositions,g=this.tickPositions.info,r=[],p;for(p=0;p<c.length;p++)this.isInAnyBreak(c[p])||r.push(c[p]);this.tickPositions=r;this.tickPositions.info=g}});E(x,"afterSetOptions",function(){this.isBroken&&(this.options.ordinal=!1)});x.prototype.setBreaks=function(c,g){function l(b){var c=b,a,n;for(n=0;n<d.breakArray.length;n++)if(a=d.breakArray[n],a.to<=b)c-=a.len;else if(a.from>=b)break;else if(d.isInBreak(a,b)){c-=b-a.from;
...
f)/d.unitLength);f&&(d.minPixelPadding=d.transA*d.minPointOffset);d.min=h;d.max=e}});t(g,!0)&&this.chart.redraw()};E(D,"afterGeneratePoints",function(){var c=this.xAxis,g=this.yAxis,r=this.points,p,d=r.length,b=this.options.connectNulls,k;if(c&&g&&(c.options.breaks||g.options.breaks))for(;d--;)p=r[d],k=null===p.y&&!1===b,k||!c.isInAnyBreak(p.x,!0)&&!g.isInAnyBreak(p.y,!0)||(r.splice(d,1),this.data[d]&&this.data[d].destroyElements())});E(D,"afterRender",function(){this.drawBreaks(this.xAxis,["x"]);
this.drawBreaks(this.yAxis,t(this.pointArrayMap,["y"]))});c.Series.prototype.drawBreaks=function(c,g){var l=this,p=l.points,d,b,k,v;c&&g.forEach(function(a){d=c.breakArray||[];b=c.isXAxis?c.min:t(l.options.threshold,c.min);p.forEach(function(n){v=t(n["stack"+a.toUpperCase()],n[a]);d.forEach(function(a){k=!1;if(b<a.from&&v>a.to||b>a.from&&v<a.from)k="pointBreak";else if(b<a.from&&v>a.from&&v<a.to||b>a.from&&v>a.to&&v<a.from)k="pointInBreak";k&&A(c,k,{point:n,brk:a})})})})};c.Series.prototype.gappedPath=
function(){var l=this.currentDataGrouping,g=l&&l.gapSize,l=this.options.gapSize,r=this.points.slice(),p=r.length-1,d=this.yAxis;if(l&&0<p)for("value"!==this.options.gapUnit&&(l*=this.closestPointRange),g&&g>l&&(l=g);p--;)r[p+1].x-r[p].x>l&&(g=(r[p].x+r[p+1].x)/2,r.splice(p+1,0,{isNull:!0,x:g}),this.options.stacking&&(g=d.stacks[this.stackKey][g]=new c.StackItem(d,d.options.stackLabels,!1,g,this.stack),g.total=0));return this.getGraphPath(r)}});B(q,"masters/modules/broken-axis.src.js",[],function(){});
B(q,"parts/DataGrouping.js",[q["parts/Globals.js"]],function(c){var q=c.addEvent,t=c.arrayMax,B=c.arrayMin,u=c.Axis,z=c.defaultPlotOptions,A=c.defined,x=c.extend,D=c.format,C=c.isNumber,l=c.merge,g=c.pick,r=c.Point,p=c.Series,d=c.Tooltip,b=c.approximations={sum:function(a){var f=a.length,b;if(!f&&a.hasNulls)b=null;else if(f)for(b=0;f--;)b+=a[f];return b},average:function(a){var f=a.length;a=b.sum(a);C(a)&&f&&(a/=f);return a},averages:function(){var a=[];[].forEach.call(arguments,function(f){a.push(b.average(f))});
return void 0===a[0]?void 0:a},open:function(a){return a.length?a[0]:a.hasNulls?null:void 0},high:function(a){return a.length?t(a):a.hasNulls?null:void 0},low:function(a){return a.length?B(a):a.hasNulls?null:void 0},close:function(a){return a.length?a[a.length-1]:a.hasNulls?null:void 0},ohlc:function(a,e,c,d){a=b.open(a);e=b.high(e);c=b.low(c);d=b.close(d);if(C(a)||C(e)||C(c)||C(d))return[a,e,c,d]},range:function(a,e){a=b.low(a);e=b.high(e);if(C(a)||C(e))return[a,e];if(null===a&&null===e)return null}},
k=function(a,e,c,d){var f=this,h=f.data,m=f.options&&f.options.data,n=[],g=[],k=[],y=a.length,p,w,F=!!e,G=[],r=f.pointArrayMap,v=r&&r.length,t=["x"].concat(r||["y"]),u=0,D=0,z,x;d="function"===typeof d?d:b[d]?b[d]:b[f.getDGApproximation&&f.getDGApproximation()||"average"];v?r.forEach(function(){G.push([])}):G.push([]);z=v||1;for(x=0;x<=y&&!(a[x]>=c[0]);x++);for(x;x<=y;x++){for(;void 0!==c[u+1]&&a[x]>=c[u+1]||x===y;){p=c[u];f.dataGroupInfo={start:f.cropStart+D,length:G[0].length};w=d.apply(f,G);f.pointClass&&
!A(f.dataGroupInfo.options)&&(f.dataGroupInfo.options=l(f.pointClass.prototype.optionsToObject.call({series:f},f.options.data[f.cropStart+D])),t.forEach(function(a){delete f.dataGroupInfo.options[a]}));void 0!==w&&(n.push(p),g.push(w),k.push(f.dataGroupInfo));D=x;for(p=0;p<z;p++)G[p].length=0,G[p].hasNulls=!1;u+=1;if(x===y)break}if(x===y)break;if(r){p=f.cropStart+x;w=h&&h[p]||f.pointClass.prototype.applyOptions.apply({series:f},[m[p]]);var q;for(p=0;p<v;p++)q=w[r[p]],C(q)?G[p].push(q):null===q&&(G[p].hasNulls=
...
this.forceCrop=c;this.groupPixelWidth=null;this.hasProcessed=!0;c&&!this.requireSorting&&(this.requireSorting=p=!0);c=!1===n.apply(this,arguments)||!c;p&&(this.requireSorting=!1);if(!c){this.destroyGroupedData();var w,c=b.groupAll?this.xData:this.processedXData,l=b.groupAll?this.yData:this.processedYData,r=f.plotSizeX,f=this.xAxis,v=f.options.ordinal,t=this.groupPixelWidth=f.getGroupPixelWidth&&f.getGroupPixelWidth();if(t){this.isDirty=h=!0;this.points=null;p=f.getExtremes();k=p.min;var p=p.max,v=
v&&f.getGroupIntervalFactor(k,p,this)||1,t=t*(p-k)/r*v,r=f.getTimeTicks(f.normalizeTimeTickInterval(t,b.units||e),Math.min(k,c[0]),Math.max(p,c[c.length-1]),f.options.startOfWeek,c,this.closestPointRange),l=a.groupData.apply(this,[c,l,r,b.approximation]),c=l.groupedXData,v=l.groupedYData,u=0;if(b.smoothed&&c.length){w=c.length-1;for(c[w]=Math.min(c[w],p);w--&&0<w;)c[w]+=t/2;c[0]=Math.max(c[0],k)}for(w=1;w<r.length;w++)r.info.segmentStarts&&-1!==r.info.segmentStarts.indexOf(w)||(u=Math.max(r[w]-r[w-
1],u));k=r.info;k.gapSize=u;this.closestPointRange=r.info.totalRange;this.groupMap=l.groupMap;if(A(c[0])&&c[0]<f.dataMin&&d){if(!A(f.options.min)&&f.min<=f.dataMin||f.min===f.dataMin)f.min=c[0];f.dataMin=c[0]}b.groupAll&&(b=this.cropData(c,v,f.min,f.max,1),c=b.xData,v=b.yData);this.processedXData=c;this.processedYData=v}else this.groupMap=null;this.hasGroupedData=h;this.currentDataGrouping=k;this.preventGraphAnimation=(m&&m.totalRange)!==(k&&k.totalRange)}};a.destroyGroupedData=function(){var a=this.groupedData;
(a||[]).forEach(function(b,f){b&&(a[f]=b.destroy?b.destroy():null)});this.groupedData=null};a.generatePoints=function(){m.apply(this);this.destroyGroupedData();this.groupedData=this.hasGroupedData?this.points:null};q(r,"update",function(){if(this.dataGroup)return c.error(24,!1,this.series.chart),!1});q(d,"headerFormatter",function(a){var b=this.chart.time,f=a.labelConfig,e=f.series,c=e.tooltipOptions,d=e.options.dataGrouping,h=c.xDateFormat,m,n=e.xAxis,g,k=c[(a.isFooter?"footer":"header")+"Format"];
...
function(c){var q=c.Point,t=c.seriesType,B=c.seriesTypes;t("ohlc","column",{lineWidth:1,tooltip:{pointFormat:'\x3cspan style\x3d"color:{point.color}"\x3e\u25cf\x3c/span\x3e \x3cb\x3e {series.name}\x3c/b\x3e\x3cbr/\x3eOpen: {point.open}\x3cbr/\x3eHigh: {point.high}\x3cbr/\x3eLow: {point.low}\x3cbr/\x3eClose: {point.close}\x3cbr/\x3e'},threshold:null,states:{hover:{lineWidth:3}},stickyTracking:!0},{directTouch:!1,pointArrayMap:["open","high","low","close"],toYData:function(c){return[c.open,c.high,c.low,
c.close]},pointValKey:"close",pointAttrToOptions:{stroke:"color","stroke-width":"lineWidth"},init:function(){B.column.prototype.init.apply(this,arguments);this.options.stacking=!1},pointAttribs:function(c,t){t=B.column.prototype.pointAttribs.call(this,c,t);var u=this.options;delete t.fill;!c.options.color&&u.upColor&&c.open<c.close&&(t.stroke=u.upColor);return t},translate:function(){var c=this,t=c.yAxis,A=!!c.modifyValue,x=["plotOpen","plotHigh","plotLow","plotClose","yBottom"];B.column.prototype.translate.apply(c);
c.points.forEach(function(u){[u.open,u.high,u.low,u.close,u.low].forEach(function(q,l){null!==q&&(A&&(q=c.modifyValue(q)),u[x[l]]=t.toPixels(q,!0))});u.tooltipPos[1]=u.plotHigh+t.pos-c.chart.plotTop})},drawPoints:function(){var c=this,t=c.chart;c.points.forEach(function(u){var x,q,z,l,g=u.graphic,r,p=!g;void 0!==u.plotY&&(g||(u.graphic=g=t.renderer.path().add(c.group)),t.styledMode||g.attr(c.pointAttribs(u,u.selected&&"select")),q=g.strokeWidth()%2/2,r=Math.round(u.plotX)-q,z=Math.round(u.shapeArgs.width/
2),l=["M",r,Math.round(u.yBottom),"L",r,Math.round(u.plotHigh)],null!==u.open&&(x=Math.round(u.plotOpen)+q,l.push("M",r,x,"L",r-z,x)),null!==u.close&&(x=Math.round(u.plotClose)+q,l.push("M",r,x,"L",r+z,x)),g[p?"attr":"animate"]({d:l}).addClass(u.getClassName(),!0))})},animate:null},{getClassName:function(){return q.prototype.getClassName.call(this)+(this.open<this.close?" highcharts-point-up":" highcharts-point-down")}})});B(q,"parts/CandlestickSeries.js",[q["parts/Globals.js"]],function(c){var q=
c.defaultPlotOptions,t=c.merge,B=c.seriesType,u=c.seriesTypes;B("candlestick","ohlc",t(q.column,{states:{hover:{lineWidth:2}},tooltip:q.ohlc.tooltip,threshold:null,lineColor:"#000000",lineWidth:1,upColor:"#ffffff",stickyTracking:!0}),{pointAttribs:function(c,t){var q=u.column.prototype.pointAttribs.call(this,c,t),D=this.options,z=c.open<c.close,l=D.lineColor||this.color;q["stroke-width"]=D.lineWidth;q.fill=c.options.color||(z?D.upColor||this.color:this.color);q.stroke=c.lineColor||(z?D.upLineColor||
l:l);t&&(c=D.states[t],q.fill=c.color||q.fill,q.stroke=c.lineColor||q.stroke,q["stroke-width"]=c.lineWidth||q["stroke-width"]);return q},drawPoints:function(){var c=this,t=c.chart,u=c.yAxis.reversed;c.points.forEach(function(q){var x=q.graphic,l,g,r,p,d,b,k,v=!x;void 0!==q.plotY&&(x||(q.graphic=x=t.renderer.path().add(c.group)),c.chart.styledMode||x.attr(c.pointAttribs(q,q.selected&&"select")).shadow(c.options.shadow),d=x.strokeWidth()%2/2,b=Math.round(q.plotX)-d,l=q.plotOpen,g=q.plotClose,r=Math.min(l,
g),l=Math.max(l,g),k=Math.round(q.shapeArgs.width/2),g=u?l!==q.yBottom:Math.round(r)!==Math.round(q.plotHigh),p=u?Math.round(r)!==Math.round(q.plotHigh):l!==q.yBottom,r=Math.round(r)+d,l=Math.round(l)+d,d=[],d.push("M",b-k,l,"L",b-k,r,"L",b+k,r,"L",b+k,l,"Z","M",b,r,"L",b,g?Math.round(u?q.yBottom:q.plotHigh):r,"M",b,l,"L",b,p?Math.round(u?q.plotHigh:q.yBottom):l),x[v?"attr":"animate"]({d:d}).addClass(q.getClassName(),!0))})}})});B(q,"mixins/on-series.js",[q["parts/Globals.js"]],function(c){var q=
c.defined,t=c.seriesTypes,B=c.stableSort;return{getPlotBox:function(){return c.Series.prototype.getPlotBox.call(this.options.onSeries&&this.chart.get(this.options.onSeries)||this)},translate:function(){t.column.prototype.translate.apply(this);var c=this,z=c.options,A=c.chart,x=c.points,E=x.length-1,C,l=z.onSeries,l=l&&A.get(l),z=z.onKey||"y",g=l&&l.options.step,r=l&&l.points,p=r&&r.length,d=A.inverted,b=c.xAxis,k=c.yAxis,v=0,a,n,m,w;if(l&&l.visible&&p)for(v=(l.pointXOffset||0)+(l.barW||0)/2,A=l.currentDataGrouping,
n=r[p-1].x+(A?A.totalRange:0),B(x,function(a,b){return a.x-b.x}),z="plot"+z[0].toUpperCase()+z.substr(1);p--&&x[E]&&!(a=r[p],A=x[E],A.y=a.y,a.x<=A.x&&void 0!==a[z]&&(A.x<=n&&(A.plotY=a[z],a.x<A.x&&!g&&(m=r[p+1])&&void 0!==m[z]&&(w=(A.x-a.x)/(m.x-a.x),A.plotY+=w*(m[z]-a[z]),A.y+=w*(m.y-a.y))),E--,p++,0>E)););x.forEach(function(a,e){var f;a.plotX+=v;if(void 0===a.plotY||d)0<=a.plotX&&a.plotX<=b.len?d?(a.plotY=b.translate(a.x,0,1,0,1),a.plotX=q(a.y)?k.translate(a.y,0,0,0,1):0):a.plotY=(b.opposite?0:
c.yAxis.len)+b.offset:a.shapeArgs={};(C=x[e-1])&&C.plotX===a.plotX&&(void 0===C.stackIndex&&(C.stackIndex=0),f=C.stackIndex+1);a.stackIndex=f});this.onSeries=l}}});B(q,"parts/FlagsSeries.js",[q["parts/Globals.js"],q["mixins/on-series.js"]],function(c,q){function t(c){r[c+"pin"]=function(d,b,g,p,a){var n=a&&a.anchorX;a=a&&a.anchorY;var m;"circle"===c&&p>g&&(d-=Math.round((p-g)/2),g=p);m=r[c](d,b,g,p);n&&a&&(m.push("M","circle"===c?d+g/2:m[1]+m[4]/2,b>a?b:b+p,"L",n,a),m=m.concat(r.circle(n-1,a-1,2,
2)));return m}}var E=c.addEvent,u=c.merge,z=c.noop,A=c.defined,x=c.Renderer,D=c.Series,C=c.seriesType,l=c.TrackerMixin,g=c.VMLRenderer,r=c.SVGRenderer.prototype.symbols;C("flags","column",{pointRange:0,allowOverlapX:!1,shape:"flag",stackDistance:12,textAlign:"center",tooltip:{pointFormat:"{point.text}\x3cbr/\x3e"},threshold:null,y:-30,fillColor:"#ffffff",lineWidth:1,states:{hover:{lineColor:"#000000",fillColor:"#ccd6eb"}},style:{fontSize:"11px",fontWeight:"bold"}},{sorted:!1,noSharedTooltip:!0,allowDG:!1,
...
m=n.y,w,h,e,f,y,r,F=this.yAxis,q={},t=[];for(h=g.length;h--;)e=g[h],r=(a?e.plotY:e.plotX)>this.xAxis.len,k=e.plotX,f=e.stackIndex,w=e.options.shape||n.shape,l=e.plotY,void 0!==l&&(l=e.plotY+m-(void 0!==f&&f*n.stackDistance)),e.anchorX=f?void 0:e.plotX,y=f?void 0:e.plotY,f=e.graphic,void 0!==l&&0<=k&&!r?(f||(f=e.graphic=b.label("",null,null,w,null,null,n.useHTML),d.styledMode||f.attr(this.pointAttribs(e)).css(u(n.style,e.style)),f.attr({align:"flag"===w?"left":"center",width:n.width,height:n.height,
"text-align":n.textAlign}).addClass("highcharts-point").add(this.markerGroup),e.graphic.div&&(e.graphic.div.point=e),d.styledMode||f.shadow(n.shadow),f.isNew=!0),0<k&&(k-=f.strokeWidth()%2),w={y:l,anchorY:y},n.allowOverlapX&&(w.x=k,w.anchorX=e.anchorX),f.attr({text:e.options.title||n.title||"A"})[f.isNew?"attr":"animate"](w),n.allowOverlapX||(q[e.plotX]?q[e.plotX].size=Math.max(q[e.plotX].size,f.width):q[e.plotX]={align:0,size:f.width,target:k,anchorX:k}),e.tooltipPos=[k,l+F.pos-d.plotTop]):f&&(e.graphic=
f.destroy());n.allowOverlapX||(c.objectEach(q,function(a){a.plotX=a.anchorX;t.push(a)}),c.distribute(t,a?F.len:this.xAxis.len,100),g.forEach(function(a){var b=a.graphic&&q[a.plotX];b&&(a.graphic[a.graphic.isNew?"attr":"animate"]({x:b.pos,anchorX:a.anchorX}),A(b.pos)?a.graphic.isNew=!1:(a.graphic.attr({x:-9999,anchorX:-9999}),a.graphic.isNew=!0))}));n.useHTML&&c.wrap(this.markerGroup,"on",function(a){return c.SVGElement.prototype.on.apply(a.apply(this,[].slice.call(arguments,1)),[].slice.call(arguments,
...
buildKDTree:z,invertGroups:z},{isValid:function(){return c.isNumber(this.y)||void 0===this.y}});r.flag=function(c,d,b,g,l){var a=l&&l.anchorX||c;l=l&&l.anchorY||d;return r.circle(a-1,l-1,2,2).concat(["M",a,l,"L",c,d+g,c,d,c+b,d,c+b,d+g,c,d+g,"Z"])};t("circle");t("square");x===g&&["flag","circlepin","squarepin"].forEach(function(c){g.prototype.symbols[c]=r[c]})});B(q,"parts/RangeSelector.js",[q["parts/Globals.js"]],function(c){function q(a){this.init(a)}var t=c.addEvent,B=c.Axis,u=c.Chart,z=c.css,
A=c.createElement,x=c.defaultOptions,D=c.defined,C=c.destroyObjectProperties,l=c.discardElement,g=c.extend,r=c.fireEvent,p=c.isNumber,d=c.merge,b=c.pick,k=c.pInt,v=c.splat;g(x,{rangeSelector:{verticalAlign:"top",buttonTheme:{width:28,height:18,padding:2,zIndex:7},floating:!1,x:0,y:0,height:void 0,inputPosition:{align:"right",x:0,y:0},buttonPosition:{align:"left",x:0,y:0},labelStyle:{color:"#666666"}}});x.lang=d(x.lang,{rangeSelectorZoom:"Zoom",rangeSelectorFrom:"From",rangeSelectorTo:"To"});q.prototype=
{clickButton:function(a,c){var d=this.chart,g=this.buttonOptions[a],h=d.xAxis[0],e=d.scroller&&d.scroller.getUnionExtremes()||h||{},f=e.dataMin,n=e.dataMax,k,l=h&&Math.round(Math.min(h.max,b(n,h.max))),q=g.type,r,e=g._range,u,x,S,z=g.dataGrouping;if(null!==f&&null!==n){d.fixedRange=e;z&&(this.forcedDataGrouping=!0,B.prototype.setDataGrouping.call(h||{chart:this.chart},z,!1),this.frozenStates=g.preserveDataGrouping);if("month"===q||"year"===q)h?(q={range:g,max:l,chart:d,dataMin:f,dataMax:n},k=h.minFromRange.call(q),
...
(r=v(d.options.xAxis)[0],S=r.range,r.range=e,x=r.min,r.min=u,t(d,"load",function(){r.range=S;r.min=x}))}},setSelected:function(a){this.selected=this.options.selected=a},defaultButtons:[{type:"month",count:1,text:"1m"},{type:"month",count:3,text:"3m"},{type:"month",count:6,text:"6m"},{type:"ytd",text:"YTD"},{type:"year",count:1,text:"1y"},{type:"all",text:"All"}],init:function(a){var b=this,c=a.options.rangeSelector,d=c.buttons||[].concat(b.defaultButtons),h=c.selected,e=function(){var a=b.minInput,
c=b.maxInput;a&&a.blur&&r(a,"blur");c&&c.blur&&r(c,"blur")};b.chart=a;b.options=c;b.buttons=[];b.buttonOptions=d;this.unMouseDown=t(a.container,"mousedown",e);this.unResize=t(a,"resize",e);d.forEach(b.computeButtonRange);void 0!==h&&d[h]&&this.clickButton(h,!1);t(a,"load",function(){a.xAxis&&a.xAxis[0]&&t(a.xAxis[0],"setExtremes",function(c){this.max-this.min!==a.fixedRange&&"rangeSelectorButton"!==c.trigger&&"updatedData"!==c.trigger&&b.forcedDataGrouping&&!b.frozenStates&&this.setDataGrouping(!1,
!1)})})},updateButtonStates:function(){var a=this,b=this.chart,c=b.xAxis[0],d=Math.round(c.max-c.min),h=!c.hasVisibleSeries,e=b.scroller&&b.scroller.getUnionExtremes()||c,f=e.dataMin,g=e.dataMax,b=a.getYTDExtremes(g,f,b.time.useUTC),k=b.min,l=b.max,q=a.selected,r=p(q),t=a.options.allButtonsEnabled,u=a.buttons;a.buttonOptions.forEach(function(b,e){var m=b._range,n=b.type,p=b.count||1,w=u[e],y=0,F=b._offsetMax-b._offsetMin;b=e===q;var v=m>g-f,x=m<c.minRange,G=!1,z=!1,m=m===d;("month"===n||"year"===
n)&&d+36E5>=864E5*{month:28,year:365}[n]*p-F&&d-36E5<=864E5*{month:31,year:366}[n]*p+F?m=!0:"ytd"===n?(m=l-k+F===d,G=!b):"all"===n&&(m=c.max-c.min>=g-f,z=!b&&r&&m);n=!t&&(v||x||z||h);p=b&&m||m&&!r&&!G||b&&a.frozenStates;n?y=3:p&&(r=!0,y=2);w.state!==y&&(w.setState(y),0===y&&q===e&&a.setSelected(null))})},computeButtonRange:function(a){var c=a.type,d=a.count||1,g={millisecond:1,second:1E3,minute:6E4,hour:36E5,day:864E5,week:6048E5};if(g[c])a._range=g[c]*d;else if("month"===c||"year"===c)a._range=864E5*
...
{left:b.translateX+c.x+"px",top:b.translateY+"px",width:c.width-2+"px",height:c.height-2+"px",border:"2px solid silver"})},hideInput:function(a){z(this[a+"Input"],{border:0,width:"1px",height:"1px"});this.setInputValue(a)},drawInput:function(a){function b(){var a=r.value,b=(f.inputDateParser||Date.parse)(a),c=l.xAxis[0],e=l.scroller&&l.scroller.xAxis?l.scroller.xAxis:c,d=e.dataMin,e=e.dataMax;b!==r.previousValue&&(r.previousValue=b,p(b)||(b=a.split("-"),b=Date.UTC(k(b[0]),k(b[1])-1,k(b[2]))),p(b)&&
(l.time.useUTC||(b+=6E4*(new Date).getTimezoneOffset()),q?b>m.maxInput.HCTime?b=void 0:b<d&&(b=d):b<m.minInput.HCTime?b=void 0:b>e&&(b=e),void 0!==b&&c.setExtremes(q?b:c.min,q?c.max:b,void 0,void 0,{trigger:"rangeSelectorInput"})))}var m=this,l=m.chart,h=l.renderer.style||{},e=l.renderer,f=l.options.rangeSelector,y=m.div,q="min"===a,r,t,u=this.inputGroup;this[a+"Label"]=t=e.label(x.lang[q?"rangeSelectorFrom":"rangeSelectorTo"],this.inputGroup.offset).addClass("highcharts-range-label").attr({padding:2}).add(u);
u.offset+=t.width+5;this[a+"DateBox"]=e=e.label("",u.offset).addClass("highcharts-range-input").attr({padding:2,width:f.inputBoxWidth||90,height:f.inputBoxHeight||17,"text-align":"center"}).on("click",function(){m.showInput(a);m[a+"Input"].focus()});l.styledMode||e.attr({stroke:f.inputBoxBorderColor||"#cccccc","stroke-width":1});e.add(u);u.offset+=e.width+(q?10:0);this[a+"Input"]=r=A("input",{name:a,className:"highcharts-range-selector",type:"text"},{top:l.plotTop+"px"},y);l.styledMode||(t.css(d(h,
f.labelStyle)),e.css(d({color:"#333333"},h,f.inputStyle)),z(r,g({position:"absolute",border:0,width:"1px",height:"1px",padding:0,textAlign:"center",fontSize:h.fontSize,fontFamily:h.fontFamily,top:"-9999em"},f.inputStyle)));r.onfocus=function(){m.showInput(a)};r.onblur=function(){r===c.doc.activeElement&&(b(),m.hideInput(a),r.blur())};r.onchange=b;r.onkeypress=function(a){13===a.keyCode&&b()}},getPosition:function(){var a=this.chart,b=a.options.rangeSelector,a="top"===b.verticalAlign?a.plotTop-a.axisOffset[0]:
0;return{buttonTop:a+b.buttonPosition.y,inputTop:a+b.inputPosition.y-10}},getYTDExtremes:function(a,b,c){var d=this.chart.time,g=new d.Date(a),e=d.get("FullYear",g);c=c?d.Date.UTC(e,0,1):+new d.Date(e,0,1);b=Math.max(b||0,c);g=g.getTime();return{max:Math.min(a||g,g),min:b}},render:function(a,c){var d=this,g=d.chart,h=g.renderer,e=g.container,f=g.options,k=f.exporting&&!1!==f.exporting.enabled&&f.navigation&&f.navigation.buttonOptions,n=x.lang,l=d.div,p=f.rangeSelector,q=b(f.chart.style&&f.chart.style.zIndex,
0)+1,f=p.floating,r=d.buttons,l=d.inputGroup,t=p.buttonTheme,u=p.buttonPosition,v=p.inputPosition,z=p.inputEnabled,E=t&&t.states,C=g.plotLeft,D,B=d.buttonGroup,L;L=d.rendered;var M=d.options.verticalAlign,O=g.legend,P=O&&O.options,Q=u.y,N=v.y,R=L||!1,T=R?"animate":"attr",K=0,I=0,J;if(!1!==p.enabled){L||(d.group=L=h.g("range-selector-group").attr({zIndex:7}).add(),d.buttonGroup=B=h.g("range-selector-buttons").add(L),d.zoomText=h.text(n.rangeSelectorZoom,0,15).add(B),g.styledMode||(d.zoomText.css(p.labelStyle),
t["stroke-width"]=b(t["stroke-width"],0)),d.buttonOptions.forEach(function(a,b){r[b]=h.button(a.text,0,0,function(c){var e=a.events&&a.events.click,f;e&&(f=e.call(a,c));!1!==f&&d.clickButton(b);d.isActive=!0},t,E&&E.hover,E&&E.select,E&&E.disabled).attr({"text-align":"center"}).add(B)}),!1!==z&&(d.div=l=A("div",null,{position:"relative",height:0,zIndex:q}),e.parentNode.insertBefore(l,e),d.inputGroup=l=h.g("input-group").add(L),l.offset=0,d.drawInput("min"),d.drawInput("max")));d.zoomText[T]({x:b(C+
u.x,C)});D=b(C+u.x,C)+d.zoomText.getBBox().width+5;d.buttonOptions.forEach(function(a,c){r[c][T]({x:D});D+=r[c].width+b(p.buttonSpacing,5)});C=g.plotLeft-g.spacing[3];d.updateButtonStates();k&&this.titleCollision(g)&&"top"===M&&"right"===u.align&&u.y+B.getBBox().height-12<(k.y||0)+k.height&&(K=-40);"left"===u.align?J=u.x-g.spacing[3]:"right"===u.align&&(J=u.x+K-g.spacing[1]);B.align({y:u.y,width:B.getBBox().width,align:u.align,x:J},!0,g.spacingBox);d.group.placed=R;d.buttonGroup.placed=R;!1!==z&&
...
this.range,c={month:"Month",year:"FullYear"}[a.type],d,g=this.max,h,e,f=function(a,b){var e=new Date(a),d=e["get"+c]();e["set"+c](d+b);d===e["get"+c]()&&e.setDate(0);return e.getTime()-a};p(a)?(d=g-a,e=a):(d=g+f(g,-a.count),this.chart&&(this.chart.fixedRange=g-d));h=b(this.dataMin,Number.MIN_VALUE);p(d)||(d=h);d<=h&&(d=h,void 0===e&&(e=f(d,a.count)),this.newMax=Math.min(d+e,this.dataMax));p(g)||(d=void 0);return d};c.RangeSelector||(t(u,"afterGetContainer",function(){this.options.rangeSelector.enabled&&
(this.rangeSelector=new q(this))}),t(u,"beforeRender",function(){var a=this.axes,b=this.rangeSelector;b&&(p(b.deferredYTDClick)&&(b.clickButton(b.deferredYTDClick),delete b.deferredYTDClick),a.forEach(function(a){a.updateNames();a.setScale()}),this.getAxisMargins(),b.render(),a=b.options.verticalAlign,b.options.floating||("bottom"===a?this.extraBottomMargin=!0:"middle"!==a&&(this.extraTopMargin=!0)))}),t(u,"update",function(a){var b=a.options.rangeSelector;a=this.rangeSelector;var c=this.extraBottomMargin,
d=this.extraTopMargin;b&&b.enabled&&!D(a)&&(this.options.rangeSelector.enabled=!0,this.rangeSelector=new q(this));this.extraTopMargin=this.extraBottomMargin=!1;a&&(a.render(),b=b&&b.verticalAlign||a.options&&a.options.verticalAlign,a.options.floating||("bottom"===b?this.extraBottomMargin=!0:"middle"!==b&&(this.extraTopMargin=!0)),this.extraBottomMargin!==c||this.extraTopMargin!==d)&&(this.isDirtyBox=!0)}),t(u,"render",function(){var a=this.rangeSelector;a&&!a.options.floating&&(a.render(),a=a.options.verticalAlign,
"bottom"===a?this.extraBottomMargin=!0:"middle"!==a&&(this.extraTopMargin=!0))}),t(u,"getMargins",function(){var a=this.rangeSelector;a&&(a=a.getHeight(),this.extraTopMargin&&(this.plotTop+=a),this.extraBottomMargin&&(this.marginBottom+=a))}),u.prototype.callbacks.push(function(a){function b(){c=a.xAxis[0].getExtremes();p(c.min)&&d.render(c.min,c.max)}var c,d=a.rangeSelector,g,e;d&&(e=t(a.xAxis[0],"afterSetExtremes",function(a){d.render(a.min,a.max)}),g=t(a,"redraw",b),b());t(a,"destroy",function(){d&&
(g(),e())})}),c.RangeSelector=q)});B(q,"parts/StockChart.js",[q["parts/Globals.js"]],function(c){var q=c.addEvent,t=c.arrayMax,B=c.arrayMin,u=c.Axis,z=c.Chart,A=c.defined,x=c.extend,D=c.format,C=c.isNumber,l=c.isString,g=c.merge,r=c.pick,p=c.Point,d=c.Renderer,b=c.Series,k=c.splat,v=c.SVGRenderer,a=c.VMLRenderer,n=b.prototype,m=n.init,w=n.processData,h=p.prototype.tooltipFormatter;c.StockChart=c.stockChart=function(a,b,d){var e=l(a)||a.nodeName,f=arguments[e?1:0],h=f,n=f.series,m=c.getOptions(),p,
q=r(f.navigator&&f.navigator.enabled,m.navigator.enabled,!0),y=q?{startOnTick:!1,endOnTick:!1}:null,t={marker:{enabled:!1,radius:2}},u={shadow:!1,borderWidth:0};f.xAxis=k(f.xAxis||{}).map(function(a,b){return g({minPadding:0,maxPadding:0,overscroll:0,ordinal:!0,title:{text:null},labels:{overflow:"justify"},showLastLabel:!0},m.xAxis,m.xAxis&&m.xAxis[b],a,{type:"datetime",categories:null},y)});f.yAxis=k(f.yAxis||{}).map(function(a,b){p=r(a.opposite,!0);return g({labels:{y:-2},opposite:p,showLastLabel:!(!a.categories&&
"category"!==a.type),title:{text:null}},m.yAxis,m.yAxis&&m.yAxis[b],a)});f.series=null;f=g({chart:{panning:!0,pinchType:"x"},navigator:{enabled:q},scrollbar:{enabled:r(m.scrollbar.enabled,!0)},rangeSelector:{enabled:r(m.rangeSelector.enabled,!0)},title:{text:null},tooltip:{split:r(m.tooltip.split,!0),crosshairs:!0},legend:{enabled:!1},plotOptions:{line:t,spline:t,area:t,areaspline:t,arearange:t,areasplinerange:t,column:u,columnrange:u,candlestick:u,ohlc:u}},f,{isStock:!0});f.series=h.series=n;return e?
...
q(u,"getPlotLinePath",function(a){function b(a){var b="xAxis"===a?"yAxis":"xAxis";a=d.options[b];return C(a)?[g[b][a]]:l(a)?[g.get(a)]:e.map(function(a){return a[b]})}var d=this,e=this.isLinked&&!this.series?this.linkedParent.series:this.series,g=d.chart,h=g.renderer,k=d.left,n=d.top,m,p,q,t,u=[],v=[],w,x,z=a.translatedValue,B=a.value,D=a.force,E;if("xAxis"===d.coll||"yAxis"===d.coll)a.preventDefault(),v=b(d.coll),w=d.isXAxis?g.yAxis:g.xAxis,w.forEach(function(a){if(A(a.options.id)?-1===a.options.id.indexOf("navigator"):
1){var b=a.isXAxis?"yAxis":"xAxis",b=A(a.options[b])?g[b][a.options[b]]:g[b][0];d===b&&v.push(a)}}),x=v.length?[]:[d.isXAxis?g.yAxis[0]:g.xAxis[0]],v.forEach(function(a){-1!==x.indexOf(a)||c.find(x,function(b){return b.pos===a.pos&&b.len===a.len})||x.push(a)}),E=r(z,d.translate(B,null,null,a.old)),C(E)&&(d.horiz?x.forEach(function(a){var b;p=a.pos;t=p+a.len;m=q=Math.round(E+d.transB);"pass"!==D&&(m<k||m>k+d.width)&&(D?m=q=Math.min(Math.max(k,m),k+d.width):b=!0);b||u.push("M",m,p,"L",q,t)}):x.forEach(function(a){var b;
m=a.pos;q=m+a.len;p=t=Math.round(n+d.height-E);"pass"!==D&&(p<n||p>n+d.height)&&(D?p=t=Math.min(Math.max(n,p),d.top+d.height):b=!0);b||u.push("M",m,p,"L",q,t)})),a.path=0<u.length?h.crispPolyLine(u,a.lineWidth||1):null});v.prototype.crispPolyLine=function(a,b){var c;for(c=0;c<a.length;c+=6)a[c+1]===a[c+4]&&(a[c+1]=a[c+4]=Math.round(a[c+1])-b%2/2),a[c+2]===a[c+5]&&(a[c+2]=a[c+5]=Math.round(a[c+2])+b%2/2);return a};d===a&&(a.prototype.crispPolyLine=v.prototype.crispPolyLine);q(u,"afterHideCrosshair",
function(){this.crossLabel&&(this.crossLabel=this.crossLabel.hide())});q(u,"afterDrawCrosshair",function(a){var b,c;if(A(this.crosshair.label)&&this.crosshair.label.enabled&&this.cross){var d=this.chart,e=this.options.crosshair.label,g=this.horiz;b=this.opposite;c=this.left;var h=this.top,k=this.crossLabel,l=e.format,m="",n="inside"===this.options.tickPosition,p=!1!==this.crosshair.snap,q=0,t=a.e||this.cross&&this.cross.e,u=a.point;a=this.lin2log;var v,w;this.isLog?(v=a(this.min),w=a(this.max)):(v=
this.min,w=this.max);a=g?"center":b?"right"===this.labelAlign?"right":"left":"left"===this.labelAlign?"left":"center";k||(k=this.crossLabel=d.renderer.label(null,null,null,e.shape||"callout").addClass("highcharts-crosshair-label"+(this.series[0]&&" highcharts-color-"+this.series[0].colorIndex)).attr({align:e.align||a,padding:r(e.padding,8),r:r(e.borderRadius,3),zIndex:2}).add(this.labelGroup),d.styledMode||k.attr({fill:e.backgroundColor||this.series[0]&&this.series[0].color||"#666666",stroke:e.borderColor||
"","stroke-width":e.borderWidth||0}).css(x({color:"#ffffff",fontWeight:"normal",fontSize:"11px",textAlign:"center"},e.style)));g?(a=p?u.plotX+c:t.chartX,h+=b?0:this.height):(a=b?this.width+c:0,h=p?u.plotY+h:t.chartY);l||e.formatter||(this.isDatetimeAxis&&(m="%b %d, %Y"),l="{value"+(m?":"+m:"")+"}");m=p?u[this.isXAxis?"x":"y"]:this.toValue(g?t.chartX:t.chartY);k.attr({text:l?D(l,{value:m},d.time):e.formatter.call(this,m),x:a,y:h,visibility:m<v||m>w?"hidden":"visible"});e=k.getBBox();if(g){if(n&&!b||
...
this.pointValKey||"y")),a=0;a<h-g;a++)if(k=d[a]&&-1<b?d[a][b]:d[a],C(k)&&c[a+g]>=this.xAxis.min&&0!==k){this.compareValue=k;break}};q(b,"afterGetExtremes",function(){if(this.modifyValue){var a=[this.modifyValue(this.dataMin),this.modifyValue(this.dataMax)];this.dataMin=B(a);this.dataMax=t(a)}});u.prototype.setCompare=function(a,b){this.isXAxis||(this.series.forEach(function(b){b.setCompare(a)}),r(b,!0)&&this.chart.redraw())};p.prototype.tooltipFormatter=function(a){a=a.replace("{point.change}",(0<
this.change?"+":"")+c.numberFormat(this.change,r(this.series.tooltipOptions.changeDecimals,2)));return h.apply(this,[a])};q(b,"render",function(){var a;this.chart.is3d&&this.chart.is3d()||this.chart.polar||!this.xAxis||this.xAxis.isRadial||(a=this.yAxis.len-(this.xAxis.axisLine?Math.floor(this.xAxis.axisLine.strokeWidth()/2):0),!this.clipBox&&this.animate?(this.clipBox=g(this.chart.clipBox),this.clipBox.width=this.xAxis.len,this.clipBox.height=a):this.chart[this.sharedClipKey]&&(this.chart[this.sharedClipKey].animate({width:this.xAxis.len,
