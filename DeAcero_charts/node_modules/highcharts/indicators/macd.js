...
dataGrouping:{approximation:"averages"},minPointLength:0},{nameComponents:["longPeriod","shortPeriod","signalPeriod"],requiredIndicators:["ema"],pointArrayMap:["y","signal","MACD"],parallelArrays:["x","y","signal","MACD"],pointValKey:"y",markerAttribs:b.noop,getColumnMetrics:b.seriesTypes.column.prototype.getColumnMetrics,crispCol:b.seriesTypes.column.prototype.crispCol,init:function(){l.prototype.init.apply(this,arguments);this.options&&(this.options=m({signalLine:{styles:{lineColor:this.color}},
...
g[1].push({plotX:f.plotX,plotY:f.plotSignal,isNull:!h(f.plotMACD)});["macd","signal"].forEach(function(b,p){a.points=g[p];a.options=m(c[b+"Line"].styles,k);a.graph=a["graph"+b];a.currentLineZone=b+"Zones";a.zones=a[a.currentLineZone].zones;l.prototype.drawGraph.call(a);a["graph"+b]=a.graph});a.points=b;a.options=c;a.zones=d;a.currentLineZone=null},getZonesGraphs:function(a){var b=l.prototype.getZonesGraphs.call(this,a),e=b;this.currentLineZone&&(e=b.splice(this[this.currentLineZone].startIndex+1),
e.length?e.splice(0,0,a[0]):e=[a[0]]);return e},applyZones:function(){var a=this.zones;this.zones=this.signalZones.zones;l.prototype.applyZones.call(this);this.options.macdLine.zones.length&&this.graphmacd.hide();this.zones=a},getValues:function(a,b){var e=0,c=[],d=[],k=[],g,f;if(a.xData.length<b.longPeriod+b.signalPeriod)return!1;g=n.prototype.getValues(a,{period:b.shortPeriod});f=n.prototype.getValues(a,{period:b.longPeriod});g=g.values;f=f.values;for(a=1;a<=g.length;a++)h(f[a-1])&&h(f[a-1][1])&&
